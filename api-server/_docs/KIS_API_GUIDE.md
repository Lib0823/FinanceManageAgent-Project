...
> **Phase 1 (구현): 실시간 호가 + 체결가.** 체결통보(`H0STCNI0`/`H0GSCNI0`)는 **Phase 2로 보류**한다.
...
| `H0STCNI0` | 국내 | 실시간 체결통보 — **Phase 2 보류** |
| `H0GSCNI0` | 국내 | 실시간 체결통보(모의) — **Phase 2 보류** |
...
> **체결통보(`H0STCNI0`/`H0GSCNI0`)는 Phase 2로 보류** — Phase 1은 호가(`H0STASP0`/`HDFSASP0`)와 체결가(`H0STCNT0`/`HDFSCNT0`)만 중계한다.
